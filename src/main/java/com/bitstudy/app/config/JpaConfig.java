 ...
 * 간단히 말해서 @Configuration 달아놓으면 시스템이 "야 이거 설정파일이야~, 나 이거 Bean 으로 등록해줘~" 라는 뜻
 *
 * */
@Configuration
...
*                    jpa 에서 자동으로 세팉하게 해줄 때 사용하는 기능인데, 특정 데이터를 보고 있다가 생성, 수정 되면
*                    자동으로 값을 넣어주는 기능
* */
@EnableJpaAuditing
public class JpaConfig {
    ...
    public AuditorAware<String> auditorAware(){
        ...
        //TODO : 나중에 스프링 시큐리티로 인증기능 붙일 때 수정필요
    }
}
